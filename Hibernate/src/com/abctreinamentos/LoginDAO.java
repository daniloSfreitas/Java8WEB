...
public class LoginDAO {
	...
	public Login findById(java.math.BigDecimal id) {
		log.debug("getting Login instance with id: " + id);
		try {
			Login instance = (Login) sessionFactory.getCurrentSession().get("com.abctreinamentos.Login", id);
			if (instance == null) {
	...
	public List findByExample(Login instance) {
		...
		try {
			List results = sessionFactory.getCurrentSession().createCriteria("com.abctreinamentos.Login")
